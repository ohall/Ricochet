...
angular.module('RicochetApp')
  .controller('MainCtrl', function ($scope, $interval) {
        ...
        var Tri = function(attrs){
            this.context = attrs.context;
            this.vert1   = [75, 50];  //attrs.vert1;
            this.vert2   = [100, 75]; //attrs.vert2;
            this.vert3   = [100, 25]; //attrs.vert3;
            this.drawit  = function() {
                $scope.context.beginPath();
                $scope.context.moveTo(this.vert1[0],this.vert1[1]);
                $scope.context.lineTo(this.vert2[0],this.vert2[1]);
                $scope.context.lineTo(this.vert3[0],this.vert3[1]);
                $scope.context.fill();
            };
            this.init = function(){
